...
class Category:  # pylint: disable=R0904
    ...
    def add_question(self, question: QQuestion) -> bool:
        """_summary_
        Args:
    ...
    def find(self, results: list[QQuestion], title: str|None = None, tags: list[str]|None = None,
             text: str|None = None, qtype: QQuestion|None = None, dbid: int|None = None):
