...
class QQuestion:
    ...
    def __init__(self, name: dict[Language, str], dbid: int|None=None, tags: list[str]=None):
        """[summary]
        Args:
            name (str): name of the question
            dbid (int, optional): id number.
